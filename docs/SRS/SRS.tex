...
Class labels are represented as whole numbers. All observations from one class share the same class label.
...
% Do calculation
\item[R\refstepcounter{reqnum}\thereqnum \label{R:calculate}:] After reading the input data, CEWS System will perform the calculation in \iref{IM:CEWS}.
