...
\item Separability: An intrinsic characteristic of a dataset and describes how the observations from different classes mix together. \cite{guan_novel_2021}
...
& $P$ is a set of $n$ points in real space with dimension(s) $m$.\\
