...
The code has been written and implemented in a well-organized manner, meeting most of the project requirements.
...
Furthermore, this type of project was not the typical project type for the course, making it too niche for some of the reviewers. 
...
None of the available relative nieghbourhood graph libraries could generate results that came close to the results of the paper and the results could no longer be verified due to the age of the research.
Even different libraries (examined early on), disagreed on the generated graph.
So using this research for testing purposes proved to be an unsuitable approach.
On the positive side, the exclusion of this method from literature reviews is now no longer a mystery.
...
For the project to be packaged for open-source development, documentation would need to be rewritten and more documents added which would require a significant amount of work above what has already been written.
...
I would have chosen a project that has a well-established existing implementation to ensure that the results are accurate and to avoid any unnecessary difficulties in reproducing the research findings.
...
I would have focused less on matching the results of the previous research \cite{zighed_statistical_2005} and instead prioritize using other test cases to ensure the accuracy of the program's output.
